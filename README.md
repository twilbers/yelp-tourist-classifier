...
<img src="https://render.githubusercontent.com/render/math?math=sailence(g)= \frac{1}{N}sum{N-1}(i=1)sum{N}(j=i+1) 1- \frac{min(P(g|s_{i}), P(g|s_{j}))}{max(P(g|s_{i}), P(g|s_{j}))}" width="350" height="200">
